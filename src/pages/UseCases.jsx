      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box !important; }
        ...
        @media (max-width: 768px) {
          ...
          .cases-page { height: auto !important; overflow-y: auto !important; overflow: visible !important; }
          .cases-wrap { height: auto !important; overflow: visible !important; padding: 28px 20px 48px 20px !important; align-items: flex-start !important; }
          .cases-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
      `}</style>
      <Navbar />
      <div className="cases-page" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
