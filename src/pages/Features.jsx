  ...
  return (
    <div style={{ width: '100vw', minHeight: '100vh', background: 'linear-gradient(135deg,#020617,#0f172a,#020617)', fontFamily: 'system-ui,sans-serif', overflowX: 'hidden' }}>
      ...
      <div style={{ padding: '24px 32px' }}>
        <h1 style={{ fontSize: '48px', fontWeight: 900, margin: '0 0 8px 0', background: 'linear-gradient(to right,#fef9c3,#fde047,#facc15)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Features</h1>
        <p style={{ color: 'rgba(254,240,138,0.6)', margin: '0 0 32px 0', fontSize: '16px' }}>Everything you need to create the perfect audio environment.</p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {[
            ...
            <div key={title} style={{ padding: '16px', borderRadius: '8px', background: 'rgba(30,41,59,0.5)', border: '2px solid rgba(250,204,21,0.2)', display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
