      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box !important; }
        ...
        @media (max-width: 768px) {
          ...
          .features-page { height: auto !important; overflow-y: auto !important; overflow: visible !important; }
          .features-wrap { height: auto !important; overflow: visible !important; padding: 28px 20px 48px 20px !important; align-items: flex-start !important; }
          .features-card { text-align: left !important; padding: 14px 16px !important; }
        }
      `}</style>
      <Navbar />
      <div className="features-page" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
