...
export default function Home() {
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', background: 'linear-gradient(135deg,#020617,#0f172a,#020617)', fontFamily: 'system-ui,sans-serif', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box !important; }
        ...
        @media (max-width: 768px) {
          ...
          .home-page { height: auto !important; overflow-y: auto !important; overflow: visible !important; }
          .home-wrap { height: auto !important; overflow: visible !important; padding: 28px 20px 48px 20px !important; align-items: flex-start !important; }
      ...
      `}</style>
      <Navbar />
      <div className="home-page" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div className="home-wrap" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 32px 80px 32px', width: '100%' }}>
          <div style={{ width: '100%', maxWidth: '900px', textAlign: 'center' }}>
            ...
            <Link className="home-cta" to="/app" style={{ display: 'inline-block', padding: '13px 34px', borderRadius: '14px', fontWeight: 700, fontSize: '15px', background: 'linear-gradient(to right,#facc15,#fde047)', color: '#000', textDecoration: 'none', boxShadow: '0 8px 20px rgba(250,204,21,0.4)', marginBottom: '28px' }}>
