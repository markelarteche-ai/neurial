...
export default function Home() {
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', background: 'linear-gradient(135deg,#020617,#0f172a,#020617)', fontFamily: 'system-ui,sans-serif', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
      ...
      `}</style>
      <Navbar />
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 32px 80px 32px', width: '100%' }}>
        <div style={{ width: '100%', maxWidth: '900px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '56px', fontWeight: 900, letterSpacing: '4px', margin: '0 0 10px 0', background: 'linear-gradient(to right,#fef9c3,#fde047,#facc15)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>NEURIAL</h1>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
            {BENEFITS.map(([icon, title, desc]) => (
              <div key={title} style={{ padding: '20px 16px', borderRadius: '14px', background: 'rgba(30,41,59,0.5)', border: '2px solid rgba(250,204,21,0.2)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '8px' }}>
